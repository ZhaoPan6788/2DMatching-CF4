    ...
    contains
        ...
        subroutine initODESolver(this, neq, dt, rhs_fun, ts, y0)
            ...
            if (neq > 0 .and. dt > 0.d0) then
                ...
                ierr = FSUNContext_Create(c_null_ptr, this%sunctx)

                ! create SUNDIALS N_Vector
                this%sunvec_y => FN_VMake_Serial(this%neq, this%y, this%sunctx)
                ...
                ! create CVode memory
                this%cvode_mem = FCVodeCreate(CV_ADAMS, this%sunctx)
                ...
                this%sunnls => FSUNNonlinSol_FixedPoint(this%sunvec_y, 0, this%sunctx)
